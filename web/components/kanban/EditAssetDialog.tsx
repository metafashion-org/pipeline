...
/**
 * Edits the fields of one asset that people actually need to correct after creation: name, category, budget and deadline.
        ...
        <Dialog open={open} onOpenChange={openChange}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="grid gap-3 py-2">
                    ...
                    <div className="grid gap-1.5">
                        <Label htmlFor="edit-fee">Budget / fee</Label>
                        <Input
                            id="edit-fee"
                            type="number"
                            inputMode="decimal"
